...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('general-ledger-account-type-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage General Ledger Account Types</h1>
...
<?php 
	$dialog = $this->widget('ext.ecolumns.EColumnsDialog', array(
       ...
       'ecolumns' => array(
            'gridId' => 'general-ledger-account-type-grid', //id of related grid
	...
	'id'=>'general-ledger-account-type-grid',	
	'filter'=>$model,
