...
$this->breadcrumbs=array(
	'OtherDisplaySetting'=>array('index'),
	'Manage',
);

$this->menu=array(
	array('label'=>'List OtherDisplaySetting', 'url'=>array('index')),
	array('label'=>'Create OtherDisplaySetting', 'url'=>array('create')),
);
...
<h1>Manage OtherDisplaySetting</h1>
